                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="groupTable">
                            <table>
                                ...
                                <tr>
                                    <td>Payer: </td>
                                    <td>${requestScope.bill.deliveryShipping.firstName} ${requestScope.bill.deliveryShipping.lastName}</td>
                                </tr>
                                <tr>
                                    <td>Subtotal: </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ${requestScope.bill.deliveryShipping.firstName}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ${requestScope.bill.deliveryShipping.lastName}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ${requestScope.bill.deliveryShipping.email}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ${requestScope.bill.deliveryShipping.address}
                                    </td>
                                </tr>
                        ...
                        <div class="p3">
                            <div class="groupButtonF">
                                <div class="groupA">
                                    <a href="LoadPage"> <button type="button" class="btn btn-primary">Back To Shop</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
