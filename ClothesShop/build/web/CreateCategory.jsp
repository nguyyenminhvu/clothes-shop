                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__text">
                            <h4>Hello ${sessionScope.ACC.name}, help me create category please !</h4>
                    ...
                    <form action="MainController">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-6">
                                <h6 class="checkout__title">Create Category</h6>

                                <div class="checkout__input">
                                    <p>Name Category<span>*</span></p>
                                    <input type="text" name="name">
                                </div>
                                <button type="submit" class="btn btn-success">Create</button>
                                <input name="action" value="CreateCategory" hidden>
                                <!-- code them row heree  -->
