...
<%@page import="sample.model.product.Product"%>
<%@page import="sample.model.product.Cart"%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <%  double totalResult = 0;
                            ...
                            Map<Integer, Product> cartP = cart.getMapCart();
                            for (Map.Entry<Integer, Product> en : cartP.entrySet()) {
                        ...
                        <div class="p3">
                            <div class="groupButtonF">
                                <div class="groupA">
                                    <a href="MainController?action=Form"> <button type="button" class="btn btn-primary">Payment on delivery</button></a>
