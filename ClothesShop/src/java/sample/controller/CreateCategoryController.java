...
public class CreateCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = pDAO.InsertCategory(name);
            if (check) {
                url = SUCCESS;
            } else {
                url = HOME;
            ...
            System.out.println("Error at CreateCategoryController with ERROR: " + e.toString());
            request.setAttribute("ERROR", "Create Fail at CreateCategoryController!!");
        } finally {
