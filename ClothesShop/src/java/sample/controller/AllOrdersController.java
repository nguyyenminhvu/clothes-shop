 ...
 * @author ACER
 */
@WebServlet(name = "AllOrdersController", urlPatterns = {"/AllOrdersController"})
public class AllOrdersController extends HttpServlet {

    private static final String HOME = "UserManagementController";
    private static final String SUCCESS = "AllOrders.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (search != null) {
                listOrder = pDAO.SearchOrders(search);
                request.setAttribute("keySearch", search);
            } else {
                listOrder = pDAO.GetAllOrder();
            }
            ...
            System.out.println("Error at AllOrdersController with ERROR: " + e.toString());
            request.setAttribute("ERROR", "Error at AllOrdersController");
        } finally {
