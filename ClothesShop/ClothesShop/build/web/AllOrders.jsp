                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__text">
                            <h4>Hello ${sessionScope.ACC.name}, all orders is here .</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="inputStyle">
                                    <div class="shop__sidebar__search">
                                        <form action="MainController">
                                            <input name="action" type="text" value="SearchOrder" hidden>
                                            ...
                                            <td class="ActionTableTD">
                                                <div class="grBtn">
                                                    <form action="MainController" method="GET">
                                                        ...
                                                        <input name="status" value="${o.status}" hidden/>
                                                        <input name="uriBack" value="AllOrdersController" hidden/>
                            ...
                            <div class="product__pagination">
                                <c:forEach begin="${1}" end="${requestScope.sizePaging}" var="i" >
                                    <a class="${i==requestScope.page?"active":""}" href="AllOrdersController?page=${i}">${i}</a>
                                </c:forEach>
                                <style>
