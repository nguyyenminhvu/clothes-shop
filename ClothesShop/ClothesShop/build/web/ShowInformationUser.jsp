...
<c:redirect url="Login.html"></c:redirect> 
        ...
        <c:choose>
            <c:when test="${requestScope.msg ne null}" >
                <script>
                                    window.onload = function submitSuccess() {
                                        iziToast.success({
                                            title: 'FASHION ',
