...
<html lang="zxx">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/fo nt-awesome.min.css" type="text/css">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="#">Product</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="./shop-details.html">All Product</a></li>
                                    </ul>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__text">
                            <h4>Halo ${sessionScope.ACC.name}, what are you doing?</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="text" name="name" value="${requestScope.product.name}" required>
                                </div>
                                <div class="checkout__input">
                                    ...
                                    <div>
                                        <select class="form-select" aria-label="Default select example" name="idcate" required>
                                            ...
                                            <c:forEach items="${requestScope.listCategory}" var="c">
                                                <c:choose>
                                                    <c:when test="${requestScope.product.category.id eq c.id}">
                                ...
                                <div style="padding-top: 25px;" class="row">
                                    <div class="col-lg-6">
                                        <div class="checkout__input">
                                            ...
                                            <input type="number" name="quantity" value="${requestScope.product.quantity}"required min="1" >
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="checkout__input">
                                            <p>Price <span>*</span></p>
                                            <input type="number" name="price" value="${requestScope.product.price}" required min="100">
                                        </div>
                                    </div>
                                </div>
                                <div class="checkout__input">
                                    <p>Description <span>*</span></p>
                                    <textarea class="describe1" name="description" required>${requestScope.product.description}</textarea>
                                </div>
                                <div class="checkout__input">
                                    <p>URL Image <span>*</span></p>
                                    <input type="text" name="img" value="${requestScope.product.img}" required>
                                    <input hidden name="action" value="UpdateProduct">
                                    <input hidden name="id" value="${requestScope.product.id}">
                                </div>
                                <label class="toggle">
                                    <c:choose>
                                        <c:when test="${requestScope.product.isActive eq true}">
                                            <input name="isactive" class="toggle-checkbox" type="checkbox" checked>
                                        </c:when>
                                        <c:otherwise>
                                            <input name="isactive" class="toggle-checkbox" type="checkbox">
                                        </c:otherwise>
                                    </c:choose>
                                ...
                                <a style="margin-left: 20px; width: 10px" href="${requestScope.uriBack}"><input style="width: 80px" class="btn btn-secondary" value="Back" /></a>
