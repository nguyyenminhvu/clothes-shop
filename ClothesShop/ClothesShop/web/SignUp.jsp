    ...
    <body style="background-image: url(./img/pexels-andreea-ch-1166644.jpg);">
        <section>
            <div class="container-fluid">
                <form  action="MainController" id="f1">
                    <div class="row">
                            ...
                            <div class="frameOver">
                                <div class="frameOver_x">
                                    ...
                                    <div class="groupInput">
                                        ...
                                        <div class="typeInput">
                                            <input class="typeInput__content" type="text" placeholder="Username" name="username" required>
                                        </div>
                                        <div class="objectError">
                                            <p class="cusError">${requestScope.USER_ERROR.usernameError}  ${requestScope.ERROR}</p>
                                        </div>
                                    </div>
                                    <div class="groupInput">
                                        <div class="titleInput">
                                        ...
                                        <div class="objectError">
                                            <p class="cusError">${requestScope.USER_ERROR.passwordError} </p>
                                        </div>
                                    </div>
                                    <div class="groupInput">
                                        <div class="titleInput">
                                        ...
                                        <div class="objectError">
                                            <p class="cusError"> ${requestScope.USER_ERROR.rePasswordError}</p>
                                        </div>
                                    </div>
                                    <div class="groupInput">
                                        <div class="titleInput">
...
<!--                                        <div class="g-recaptcha cusCapcha" data-sitekey="6LfbaAolAAAAAMbxj9dJkIyNgi_19VPHpD0A5w88"></div>  
                                    ...
                                    <div class="buttonSubmit">
                                        ...
                                        <button type="submit" class="btn btn-dark cusButton"  name="action" value="SingUp">Sign Up</button>
                                    </div>
                                </div>
                            </div>
                        </div>
