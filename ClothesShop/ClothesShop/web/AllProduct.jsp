                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__text">
                            <h4>Protect all Product like your life, ${sessionScope.ACC.name}.</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="inputStyle">
                                    <div class="shop__sidebar__search">
                                        <form action="MainController">
                                            <input name="action" type="text" value="SearchProductByName" hidden>
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listProduct}" var="p">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${p.isActive eq true}">
                                                        Active
                                                    </c:when>
                                                    <c:otherwise>
                                                        Inactive
                                            ...
                                            <td class="ActionTableTD">
                                                <div class="grBtn">
                                                    <form action="MainController" method="GET">
                                                        ...
                                                        <input name="uriBack" value="AllProductController" hidden/>
                            ...
                            <div class="product__pagination">
                                <c:forEach begin="${1}" end="${requestScope.sizePaging}" var="i" >
                                    <a class="${i==requestScope.page?"active":""}" href="AllProductController?page=${i}">${i}</a>
                                </c:forEach>
                                <style>
