                                    ...
                                    <div class="signUp">
                                        <div class="groupSignup">
                                            ...
                                            <div class="signGoogle">
                                                login with   <a  href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/ClothesShop/LoginGoogleHandle&response_type=code
                                                                 &client_id=655491711476-0a787hdnohif2tii890m47msgbhh1fvg.apps.googleusercontent.com&approval_prompt=force"> Google</a>
                                            </div>
                                        </div>
                                    </div>
